...
import { PETSHOP_MOST_RECENT_SORT, PETSHOP_LEAST_RECENT_SORT } from '../../../actions/types';
        ...
        <div className={classes.sidebarfilter}>
            ...
            >
                ...
                <List>
                    ...
                    <ListItem  >
                        <button onClick={() => store.dispatch({ type: PETSHOP_MOST_RECENT_SORT })} className="myfilterby">Plus récent</button>
                    </ListItem>
                    <ListItem  >
                        <button onClick={() => store.dispatch({ type: PETSHOP_LEAST_RECENT_SORT })} className="myfilterby">Moin récent</button>
                    </ListItem>
                    <ListItem>
